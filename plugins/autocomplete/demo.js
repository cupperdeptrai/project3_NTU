...
$(function() {
    ...
    $('#autocomplete-ajax').autocomplete({
        ...
        onSelect: function(suggestion) {
            $('#selction-ajax').html('Đã chọn: ' + suggestion.value + ', ' + suggestion.data);
        },
        onHint: function(hint) {
            $('#autocomplete-ajax-x').val(hint);
        },
        onInvalidateSelection: function() {
            $('#selction-ajax').html('Đã chọn: Không');
        }
    });
    ...
    $('#autocomplete').devbridgeAutocomplete({
        ...
        minChars: 1,
        onSelect: function(suggestion) {
            $('#selection').html('Đã chọn: ' + suggestion.value + ', ' + suggestion.data.category);
        },
        showNoSuggestionNotice: true,
        noSuggestionNotice: 'Không có kết quả phù hợp',
        groupBy: 'Thể loại'
    });
